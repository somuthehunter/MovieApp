...
class TVShowModel extends TVShow {
  ...
  static List<TVShowModel> fromList(List<Map<String, dynamic>> list) {
    return list.map((map) => TVShowModel.fromJson(map)).toList();
  }
  ...
  static List<TVShow> toEntityList(List<TVShowModel> models) =>
